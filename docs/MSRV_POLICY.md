...
- Aerogram does not commit to supporting Rust versions older than 1.89.
...
- The baseline is reviewed in February and August. Aerogram may move ahead of it only for a concrete language, dependency, correctness, or security requirement.
